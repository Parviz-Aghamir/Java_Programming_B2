...
public class SalaryCalculeter {
     ...
     */
        public static void main(String[] args) {
            ...
            String taxReport = "State tax rate: $" + stateTax + ", Fedral tax rate: $" +federalTax + ", Base Salary: $" +
                    salary+"\nTax amount: $"+ stateTax+ " for State Tax and$" +federalTax+ "Fedral Tax, \nin total it is: $" + totalTax+
