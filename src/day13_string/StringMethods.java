...
public class StringMethods {
    public static void main(String[] args) {
        ...
        str = str +" is nice";      // Here, we made a completely new Strin
        ...
        System.out.println(a==b); // Here, we are comparing the memory location and SINCE both were
        // made using the 'new' keyword, both of them in a different location in the HEAP memory
        System.out.println(a.equals(b)); // Here, we are comparing the VALUE itself.
        // No matter what the location is in the memory, I am comparing the values.
